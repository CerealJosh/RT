      ...
      {cartItems.length > 0 ? (
        <section className="overflow-hidden py-20 bg-gray-2">
          <div className="max-w-[1170px] w-full mx-auto px-4 sm:px-8 xl:px-0">
            <div className="flex flex-wrap items-center justify-between gap-5 mb-7.5">
              <h2 className="font-medium text-dark text-2xl">Your Order</h2>
              <button className="text-blue">Clear Order</button>
            </div>
                ...
                <div className="min-w-[1170px]">
                  ...
                  <div className="flex items-center py-5.5 px-7.5">
                    <div className="min-w-[400px]">
                      <p className="text-dark">Dish</p>
                    </div>

                    <div className="min-w-[180px]">
                      <p className="text-dark">Dish Price</p>
                    </div>
        ...
        <>
          <div className="text-center mt-8">
            ...
            <p className="pb-6">Your order list is empty!</p>
